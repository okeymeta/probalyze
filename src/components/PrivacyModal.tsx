...
export const PrivacyModal: React.FC<PrivacyModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="glass-card max-w-3xl w-full max-h-[90vh] overflow-y-auto rounded-2xl border-2 border-blue-500/30 shadow-2xl shadow-blue-500/20">
        {/* Header */}
        <div className="sticky top-0 bg-[#0a0a0f]/95 backdrop-blur-xl border-b border-gray-800 p-6 z-10">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-400 text-sm">How we handle your data and protect your privacy</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-5">
            <div className="flex items-start gap-3">
              <UserCheck className="w-6 h-6 text-orange-400 flex-shrink-0 mt-1" />
              <div>
        ...
        <div className="sticky bottom-0 bg-[#0a0a0f]/95 backdrop-blur-xl border-t border-gray-800 p-6">
          <button
            onClick={onClose}
            className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold rounded-lg transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50"
          >
            Close
          </button>
        </div>
